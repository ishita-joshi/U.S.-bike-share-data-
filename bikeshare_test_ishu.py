...
#     for city in cities:
#         if city == ["chicago","new york city"]:
#             continue
#             gender = df ['Gender'].value_counts()
#             print('The counts of gender are {}.'.format(gender)) 
#     else:
#         print('Sorry, gender count unavailable.')
...
#     else:
#         print('Sorry, year count is unavailable for Washington.')
    ...
    if display.lower() == 'yes':
        ...
        while display_more.lower() != 'no':
            ...
            while valid_input_2 == False:
                display_more = input('\nWould you like to view more raw'
...
def main():
    while True:
        ...
        if city == 'chicago' or city == 'new york city':
            ...
            print('Sorry,  user information unavailable for Wasington.')   
